...
## get_inf_attr(INF_MIN_EA/INF_MAX_EA)
...
## generate_disasm_line(ea, GENDSM_FORCE_CODE)
...
## get_segm_start(ea)与get_segm_end(ea)
...
## get_func_attr(ea, FUNCATTR_START/FUNCATTR_END)
...
## get_next_func(ea)与get_prev_func(ea)
...
## get_reg_value(regname)

获取寄存器值

## set_reg_value(value, regname)
