...
![ref1.1](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.1.png)

然后看IDA反汇编，可以看到gets函数没有限制，所以依旧是栈溢出。

![ref1.2](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.2.png)
...
![ref1.3](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.3.png)

这题应该不能使用ROPgadget了，但还是先试试找找gadget，可以确认确实找不到

![ref1.4](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.4.png)

里面也没有编译好的system("/bin/sh")，但是可以看到在bss段和plt表中分别有/bin/sh字符串和system的链接。

![ref1.5](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.5.png)

![ref1.6](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.6.png)

![ref1.7](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.7.png)
...
![ref1.8](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.8.png)
...
![ref1.9](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref1.9.png)
...
![ref2.1](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.1.png)

这回是/bin/sh字符串没有了，此外也没有ret2syscall需要的int 0x80。只留下了plt表中的system

![ref2.2](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.2.png)

![ref2.3](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.3.png)
...
![ref2.4](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.4.png)
...
![ref2.5](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.5.png)
...
![ref2.6](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.6.png)

最后getshell

![ref2.7](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref2.7.png)
...
![ref3.1](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref3.1.png)
...
![ref3.2](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref3.2.png)
...
![ref3.3](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref3.3.png)

getshell

![ref3.4](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref3.4.png)

此外，在kali中执行同样的payload会发现连地址都泄露不出来，经查发现是libc的问题。

![ref3.5](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref3.5.png)

把libc从2.41换成2.39就好了。

![ref3.6](/assets/images/2025-10-24-ret2libc-study-note/ret2libc/ref3.6.png)
